...
const defaultSkills = [
  ...
  { id: "4", name: "TypeScript", category: "frontend", level: 70 },
  { id: "5", name: "React", category: "frontend", level: 85 },
  { id: "6", name: "Next.js", category: "frontend", level: 85 },
  { id: "7", name: "TailwindCSS", category: "frontend", level: 95 },
  { id: "8", name: "RESTful APIs", category: "frontend", level: 90 },
  { id: "9", name: "GraphQL", category: "frontend", level: 70 },
  { id: "10", name: "Supabase", category: "backend", level: 70 },
  { id: "11", name: "Clerk", category: "backend", level: 80 },
  {
    id: "12",
  ...
  { id: "13", name: "React Native", category: "frontend", level: 60 },
  {
    id: "14",
