...
const defaultProjects: Project[] = [
  {
    ...
    title: "CineScope",
    description:
      "A modern, responsive movie discovery application built with Next.js and TypeScript. Users can search for movies, browse by genres, manage favorites, and discover trending content using the TMDB API.",
    image: "images/CineScope.webp",
    tags: [
      "Next.js 14 (SSR/SSG)",
      "TypeScript",
      "TailwindCSS",
    ...
    liveUrl: "https://my-cinescope.vercel.app",
    githubUrl: "https://github.com/pro-boost/alx-project-nexus",
  },
  {
    id: "strikeGear",
    title: "Strike Gear",
    description:
      "A modern e-commerce platform tailored for outdoor enthusiasts. Offers a seamless shopping experience with responsive design, dark/light mode toggle, and optimized builds.",
    image: "images/Strike Gear.webp",
    tags: ["Vite", "React", "TypeScript", "TailwindCSS", "Supabase", "Clerk"],
    liveUrl: "https://strike-gear.netlify.app/",
    githubUrl: "https://github.com/pro-boost/desert-gear-boutique",
  },
  {
    id: "megatech",
    title: "MegaTech",
    description:
      "A digital training platform for technical formations. Provides course management and access to specialized content with modern frontend technologies and scalable backend integration.",
    image: "images/Megatech.webp",
    tags: [
      "React",
      "TypeScript",
      "TailwindCSS",
    ...
    liveUrl: "https://gatech-formations.netlify.app",
    githubUrl: "https://github.com/pro-boost/formation-locale-architect",
  },
  {
    id: "panoViewer",
    title: "Advanced Panorama Viewer",
    description:
      "An interactive 360° panorama viewer built with Next.js and Marzipano. Features immersive navigation between connected scenes and advanced hotspot rendering.",
    image: "images/Pano-viewer.webp",
    tags: ["Next.js", "TypeScript", "Electron", "NSIS", "Marzipano API"],
    liveUrl: "#",
    githubUrl: "#",
    isComingSoon: true,
  },
